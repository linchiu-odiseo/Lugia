...
(Previously: sin cambio de comportamiento — solo actualizada la referencia a "examen" en lugar de "simulacro" en la UI copy.)
...
(Previously: sin cambio de comportamiento — solo rename de parámetro en firmas.)
